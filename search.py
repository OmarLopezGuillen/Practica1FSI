...
def graph_search(problem, fringe):
    expandidos = 0  #Numero de nodos espandidos
    visitados = 0  #Numero de nodos visitados
    ...
    maximo = len(fringe)   #Tamaño maximo de la lista abierta
    while fringe:
        node = fringe.pop()

        if problem.goal_test(node.state):
            print("Tamaño maximo de la lista abierta: ",maximo)
            print("Numero de nodos epandidos: ",expandidos)
            return node
